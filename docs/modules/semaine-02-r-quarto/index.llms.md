...
Les [six capsules vidéo du module](../../modules/semaine-02-r-quarto/capsules.llms.md) sont disponibles, avec leurs supports PDF et HTML. Les versions HTML permettent de copier-coller le code dans RStudio. Regardez-les dans l’ordre, de 1 à 6, en gardant RStudio ouvert pour reproduire les gestes.
