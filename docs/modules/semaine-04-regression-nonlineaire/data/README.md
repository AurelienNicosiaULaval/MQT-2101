...
Le [dictionnaire complet des deux cas](dictionnaires.md) précise aussi les unités des données de transfert et les variables à ne pas utiliser dans ce module. Les CSV originaux sont conservés sans modification.
