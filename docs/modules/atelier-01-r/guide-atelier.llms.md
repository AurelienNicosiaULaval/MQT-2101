...
La séance commence par une [courte présentation](../../modules/atelier-01-r/presentation.llms.md). Vous travaillez ensuite dans votre rapport, avec l’accompagnement de l’enseignant. Le [déroulement du laboratoire](../../modules/atelier-01-r/index.llms.md#pendant-latelier) prévoit un point de rétroaction pendant l’analyse, puis un premier dépôt. La rétroaction croisée et la révision du rapport se font après la séance.
...
| 6\. Bilan formatif | Au premier dépôt : difficultés et aide utilisée. Après la rétroaction croisée : commentaires reçus, corrections justifiées et point à retravailler |
...
Après le premier dépôt, l’enseignant attribue les rapports au hasard et transmet à chaque binôme le rapport à relire. Attendez cette attribution avant de commencer. Chaque binôme utilise la grille ci-dessous et envoie sa rétroaction directement aux auteurs du rapport attribué. Les échéances sont précisées dans la [présentation d’accueil](../../modules/atelier-01-r/presentation.llms.md#les-trois-échéances).

Pour chaque critère, indiquez « Acquis », « À consolider » ou « À reprendre » et justifiez votre appréciation par un élément du rapport. Relevez au moins un point réussi et une amélioration précise. Si un résultat vous semble incertain, proposez une vérification. Ces repères servent à choisir une correction, sans calcul de note.
...
| Reproductibilité et bilan | Render refait l’analyse à partir du CSV; au premier dépôt, les difficultés et l’aide utilisée sont précisées. Le bilan des corrections est complété après la rétroaction croisée |
...
## Révision après la rétroaction croisée
