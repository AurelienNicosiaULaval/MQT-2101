...
<div class="reading-grid">
  <article class="reading-card primary">
    ...
    <div class="reading-card-content">
      ...
      <p class="reading-source">Image et accès : site officiel OTexts.</p>
    </div>
  </article>
  ...
  <article class="reading-card primary">
    ...
    <div class="reading-card-content">
      ...
      <p class="reading-source">Image et accès : site officiel R for Data Science.</p>
    </div>
  </article>
  ...
  <article class="reading-card primary">
    ...
    <div class="reading-card-content">
      ...
      <p class="reading-source">Image et accès : site officiel An Introduction to Statistical Learning.</p>
    </div>
  </article>
</div>
</div>
...
<div class="reading-grid">
  <article class="reading-card secondary">
    ...
    <div class="reading-card-content">
      ...
      <p class="reading-source">Image : Open Textbook Library. Accès : OpenIntro.</p>
    </div>
  </article>
  ...
  <article class="reading-card secondary">
    ...
    <div class="reading-card-content">
      ...
      <p class="reading-source">Image et accès : sites officiels OpenIntro et Introduction to Modern Statistics.</p>
    </div>
  </article>
  ...
  <article class="reading-card secondary">
    ...
    <div class="reading-card-content">
      ...
      <p class="reading-source">Aperçu généré à partir du PDF public.</p>
    </div>
  </article>
