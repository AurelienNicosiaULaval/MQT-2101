...
Reprenez les repères de [régression linéaire](../semaine-03-regression-lineaire/index.qmd) : moyenne prédite, résidu, R², hypothèses et intervalle de prédiction. Consultez les [capsules](capsules.qmd), reproduisez les [démonstrations](demonstrations.qmd) et tentez les [exercices](exercices.qmd) avant leurs corrigés.
...
La régression logistique est traitée au [module 10](../semaine-10-classification-modeles-avances/index.qmd). Les modèles à plateau imposé, les splines, les GAM, le probit et le Tobit ne sont pas développés dans ce module.
