---
title: "Atelier 03 - Prévoir la demande"
format:
  html:
...
2. Relisez les [repères préparatoires](capsules.qmd).
3. Ouvrez un nouveau fichier Quarto et vérifiez qu'il se rend en HTML.
4. Apportez votre trace des modules 06 à 08.

## Déroulement

Suivez le [guide en classe](guide-atelier.qmd), puis utilisez les [démonstrations](demonstrations.qmd) uniquement pour débloquer une étape. Les [exercices](exercices.qmd) servent à consolider et à vérifier la trace finale.

## Lien avec le mini-rapport 2

Cet atelier est le point de contrôle pédagogique du
[mini-rapport 2](../../evaluations/mini-rapport-2.qmd). Apportez une question,
une cible et une première idée de jeu de données si vous souhaitez vérifier que
votre projet respecte la logique de prévision et de validation temporelle.
...
::: {.callout-note title="IA autorisée pour la rétroaction"}
