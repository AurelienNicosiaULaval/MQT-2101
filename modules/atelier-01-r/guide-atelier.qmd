---
title: "Mission du laboratoire 01"
subtitle: "Un premier diagnostic pour la direction"
format:
  html:
...
::: {.callout-important title="Le niveau attendu après les modules 1 et 2"}
...
La séance commence par une [courte présentation](presentation.qmd). Vous travaillez ensuite dans votre rapport, avec l'accompagnement de l'enseignant. Le [déroulement du laboratoire](index.qmd#pendant-latelier) prévoit un point de rétroaction pendant l'analyse, puis un premier dépôt. La rétroaction croisée et la révision du rapport se font après la séance.
...
::: {.callout-tip collapse="true" title="Indice : inspection et valeurs manquantes"}
...
::: {.callout-tip collapse="true" title="Indice : un indicateur adapté à la question"}
...
::: {.callout-tip collapse="true" title="Indice : choisir les bonnes données pour le graphique"}
...
::: {.callout-note title="Une conclusion descriptive et prudente"}
...
Après le premier dépôt, l'enseignant attribue les rapports au hasard et transmet à chaque binôme le rapport à relire. Attendez cette attribution avant de commencer. Chaque binôme utilise la grille ci-dessous et envoie sa rétroaction directement aux auteurs du rapport attribué. Les échéances sont précisées dans la [présentation d'accueil](presentation.qmd#les-trois-échéances).
...
4. Un seul membre du binôme redépose dans Brio le dossier révisé, avec la rétroaction reçue, selon l'échéance annoncée dans la [présentation d'accueil](presentation.qmd#les-trois-échéances).

L'enseignant fera ensuite une évaluation formative de votre travail révisé pour vous aider à préparer le [mini-rapport 1](../../evaluations/mini-rapport-1.qmd). Ce parcours ne compte pas dans la note finale.

## Aide pendant la mission

Consultez d'abord la consigne et tentez le calcul. Si nécessaire, utilisez les indices repliés de ce guide, les [exercices corrigés du module 2](../semaine-02-r-quarto/exercices.qmd) ou une [démonstration R](demonstrations.qmd). Adaptez le code à votre question et vérifiez le résultat obtenu.

Pour demander de l'aide, montrez le bloc essayé, le résultat ou le message d'erreur, et ce que vous cherchez à obtenir. Le [GPT du cours](https://chatgpt.com/g/g-6a0b2ec33d948191ad25b2f247b15de1-analyse-et-modelisation-des-donnees?ref=mini) peut servir de tuteur, conformément aux [règles du cours](../../ressources/ia.qmd), après une première tentative. Vous devez pouvoir expliquer le code et les constats conservés. Notez dans votre bilan l'aide utilisée et ce que vous avez vérifié.

Les [exercices complémentaires](exercices.qmd) sont facultatifs. Ils ne constituent pas un second rapport à produire pendant cette séance.
