...
La séance commence par une [présentation de 10 à 15 minutes](presentation.qmd). Vous travaillez ensuite dans votre rapport, avec l'accompagnement de l'enseignant. Le [déroulement horaire](index.qmd#pendant-latelier) réserve deux moments à la rétroaction.
...
::: {.callout-note title="Point de rétroaction 1, vers 10 h"}
