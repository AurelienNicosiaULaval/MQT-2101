...
::: {.learning-hero}
<p class="hero-kicker">Premier laboratoire en classe</p>
<h2>Quelle analyse proposer à la direction?</h2>
...
Mercredi 16 septembre 2026, de 9 h à 11 h 50, au pavillon Palasis-Prince, local 3213, selon le [calendrier du cours](../../calendrier.qmd).
:::

::: {.callout-note title="Un laboratoire formatif"}
...
- [ ] Vérifiez que R, RStudio ou Positron et Quarto fonctionnent, à l'aide de la [page Installation](../../installation.qmd).
...
En cas de difficulté, consultez le [guide Quarto](../../ressources/guide-quarto.qmd). Si le problème persiste, venez avec vos fichiers et le message d'erreur pour le signaler dès votre arrivée.

Les notions utiles sont l'unité d'observation, les types de variables, les valeurs manquantes, les résumés descriptifs et les graphiques. Les [exercices corrigés du module 2](../semaine-02-r-quarto/exercices.qmd) restent disponibles pour revoir un geste précis.

## Pendant l'atelier

Ouvrez le [guide de la mission](guide-atelier.qmd). Il rassemble les consignes, les étapes, le contenu du rapport et la grille formative. Gardez-le à côté de votre document Quarto pendant le travail.
...
Visez environ 400 à 600 mots, hors code et tableaux. Cette longueur est un repère pour rester concis, pas un critère de notation. Les éléments attendus et les modalités de fin de séance se trouvent dans le [guide de la mission](guide-atelier.qmd#rapport-attendu).

## Après l'atelier

Conservez ensemble le `.qmd`, le `.html` et le dossier `data/`. Reprenez le point d'amélioration relevé pendant la rétroaction et notez une question à clarifier. Cette démarche vous prépare à la rédaction du [mini-rapport 1](../../evaluations/mini-rapport-1.qmd), dont les consignes et l'évaluation sont distinctes.

## Ressources utiles

| Ressource | Quand l'utiliser |
|---|---|
| [Guide de la mission](guide-atelier.qmd) | Fil principal de la séance |
| [Présentation de lancement](presentation.qmd) | Support de la courte introduction en classe |
| [Dossier de départ : projet, QMD et CSV](../../assets/exemples/laboratoire-01.zip) | Pour commencer directement dans RStudio |
| [Démonstrations R](demonstrations.qmd) | Aide ponctuelle après une première tentative |
| [Repères conceptuels](capsules.qmd) | Pour retrouver une notion des modules 1 et 2 |
| [Exercices complémentaires](exercices.qmd) | Pratique facultative après la mission |
