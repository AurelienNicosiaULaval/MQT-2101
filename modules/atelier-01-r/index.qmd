...
L'enseignant vous transmettra un rapport attribué au hasard. Envoyez aux auteurs une rétroaction fondée sur la grille du guide. Révisez ensuite votre propre rapport à partir des commentaires reçus, complétez le bilan et redéposez le dossier dans Brio avec la rétroaction reçue. Consultez la [présentation d'accueil](presentation.qmd#les-trois-échéances) pour les échéances.

L'enseignant fera ensuite une évaluation formative du travail révisé, en préparation du [mini-rapport 1](../../evaluations/mini-rapport-1.qmd), dont les consignes et l'évaluation sont distinctes.
