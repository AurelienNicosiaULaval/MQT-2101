...
Elle sert de référence rapide pour retrouver le code vu en classe. Le parcours
complet, avec les explications, les pauses diagnostic et les moments « À vous »,
se trouve dans le [guide complet de l'atelier](guide-atelier.html).

::: {.callout-note title="Comment utiliser cette page"}
Pendant l'atelier, suivez d'abord le guide complet. Revenez ici seulement pour
retrouver un bloc de code précis ou comparer votre code avec la démonstration.
Les exercices indiquent ensuite ce qui doit être produit dans votre propre trace
finale.
:::
