...
La [mission](guide-atelier.qmd) mobilise les modules 3 et 4. Ces repères aident à vérifier une décision pendant l'analyse; ils ne constituent pas un travail supplémentaire.
...
- [Module 3 : interpréter une droite et ses résidus](../semaine-03-regression-lineaire/demonstrations.qmd).
- [Module 4 : comparer les formes et distinguer ajustement et validation](../semaine-04-regression-nonlineaire/demonstrations.qmd).
- [Documentation R et lectures utiles](lectures.qmd).
