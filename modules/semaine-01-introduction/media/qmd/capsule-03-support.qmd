...
::: {.example-box}
Dans `birth_us.csv`, `births` est une variable numérique : elle compte le nombre
...
::: {.example-box}
Dans `birth_us.csv`, `day_of_week` utilise les nombres 1 à 7. Ces nombres
...
::: {.example-box}
Dans R, `day_of_week` pourra devenir une variable catégorielle avec des libellés
comme lundi, mardi, mercredi, etc.
:::
