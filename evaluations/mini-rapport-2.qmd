---
title: "Mini-rapport 2 - Prévision ou classification"
format:
  html:
...
Suivez la [procédure de validation](validation-donnees.qmd). Les données futures ou la cible ne doivent jamais fuiter dans la préparation des prédicteurs.

## Grille

La [grille commune des mini-rapports](grille-mini-rapports.qmd) est appliquée sur 100 points puis convertie en 15 %. Pour ce rapport, la rubrique « modélisation et validation » exige explicitement une preuve hors échantillon.

## Gabarit

Utilisez le [gabarit du mini-rapport 2](../ressources/gabarit-mini-rapport-2.qmd).
