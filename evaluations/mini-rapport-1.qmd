...
- Remise : consulter le [calendrier du cours](../calendrier.qmd).
...
Suivez la [procédure de validation](validation-donnees.qmd). Les jeux identifiés comme simulés pour le cours dans la section [Données](../donnees/index.qmd) sont déjà autorisés; aucune approbation supplémentaire n'est nécessaire. Pour un autre jeu, soumettez une proposition selon cette procédure.
